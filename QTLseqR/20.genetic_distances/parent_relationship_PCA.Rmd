...
fwrite(BSAallsnps_fromvcf_wALTp, file=paste0("prediction_", "G10000_", basename(names_chrbeds_parent[b]), ".csv"), append=F)
}
...
for (i in qtl_names){
  ...
  assign(i, setnames(get(i), subset_Bases, subset_title_qtlname)) #setnames qtl_names to bases colunm 
  ...
  assign(i, cbind(get(i), apply(get(i)[,-1], 1, paste, collapse=""))) #make a single string of bases
