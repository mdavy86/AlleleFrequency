...
#in this case       REF_FRQ = ref allele depth Russell + Ref allele depth aMalePool/  DPrussell + DPxMalePool
...
```
```{r filter}
a_df <- filterSNPs(SNPset = a_df_nofilt, refAlleleFreq = 0.10, minTotalDepth = 50, maxTotalDepth = 100, depthDifference = 100, minSampleDepth = 10, minGQ = 20, verbose = TRUE)

f_df <- filterSNPs(SNPset = f_df_nofilt, refAlleleFreq = 0.10, minTotalDepth = 50, maxTotalDepth = 100, depthDifference = 100, minSampleDepth = 10, minGQ = 20, verbose = TRUE)

j_df <- filterSNPs(SNPset = j_df_nofilt, refAlleleFreq = 0.10, minTotalDepth = 50, maxTotalDepth = 100, depthDifference = 100, minSampleDepth = 10, minGQ = 20, verbose = TRUE)
```
