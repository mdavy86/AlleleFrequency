...
bcfcmd  <- "bcftools query /powerplant/workspace/hrtcdf/FSTs/Russellalt/Russellpile_chr25.vcf.gz -r 'chr25:1-10000000' -f '[%SAMPLE]\t%POS\t%REF\t%ALT\t%ALT{0}\t%ALT{1}\t%ALT{2}\t%DP\t%AD\t%AD{0}\t%AD{1}\t%AD{2}\n' 2>/dev/null"
...
bcfcmd   <- "bcftools query '/powerplant/workspace/hrtcdf/FSTs/Russellalt/Russellpile.vcf.gz' -r 'chr25' -f '%POS\t%REF\t%ALT\t%DP\n'"
