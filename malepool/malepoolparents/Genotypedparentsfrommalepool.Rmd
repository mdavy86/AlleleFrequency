...
read1_to <- file.path("/powerplant/workspace/hrtcdf/FSTs/malepool/malepoolparents", x1$read1)
read2_to <- file.path("/powerplant/workspace/hrtcdf/FSTs/malepool/malepoolparents", x1$read2)
...
```{r symlink reference}
mainDir <- "/powerplant/workspace/hrtcdf/FSTs/malepool/malepoolparents"
...
submit_bwa <- function(rg_id       = c(),
  ...
  symgenome     <- "/powerplant/workspace/hrtcdf/FSTs/malepool/malepoolparents/Russell_V2a.fa.gz"
...
bcfcalltags <- "GQ,GP"
pvalThres   <- 0.99
mainDir2    <- c("/powerplant/workspace/hrtcdf/FSTs/malepool/malepoolparents/")
...
vcfcmd      <- "bcftools view -r 'chr25' '/powerplant/workspace/hrtcdf/FSTs/malepool/malepoolparents/pileK97_03_05_07borCK06_01.bam' -Ou | bcftools query  -f'[%SAMPLE]\t%POS\t%REF\t%ALT\t%DP\t%AD\t%AD{0}\t%AD{1}\t%AD{2}\t%AD{3}\n'"
