...
```{bash} 
cd /powerplant/workspace/hrtcdf/FSTs
Dir1=TestPool
Dir2=FullPool

#cd /powerplant/workspace/hrtcdf/FSTs/$Dir1
#  for bam in *.bam ; do echo "/powerplant/workspace/hrtcdf/$Dir1/$bam" >>$Dir1"Bams.txt";
#  done
  
cd /powerplant/workspace/hrtcdf/FSTs/$Dir2
  for bam in *.bam; do echo "/powerplant/workspace/hrtcdf/GBSremap/Alignments/$Dir2/$bam" >>$Dir2.txt;
  done
